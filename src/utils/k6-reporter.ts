...
(() => {
              ...
              function (e, t, n) {
                ...
                function v(e, t) {
                  ...
                  if (
                    ((r.filename = (function (e, t) {
                      ...
                      if (o && o.length)
                        (e = e.replace(/^\/*/, '')),
                          (r = Array.isArray(t.root) ? h(e, t.root) : n.resolveInclude(e, t.root || '/', !0));
                      else if (
                        (t.filename && ((s = n.resolveInclude(e, t.filename)), i.existsSync(s) && (r = s)),
                        !r && Array.isArray(a) && (r = h(e, a)),
                        !r && 'function' != typeof t.includer)
                      )
                        throw new Error('Could not find the include file "' + t.escapeFunction(e) + '"');
                      return r;
                    })(e, r)),
                    'function' == typeof t.includer)
                  ) {
                    var a = t.includer(e, r.filename);
                    if (a && (a.filename && (r.filename = a.filename), a.template)) return m(r, a.template);
                  }
                  return m(r);
                }
                ...
                function x(e, t) {
                  ...
                  (this.templateText = e),
                    ...
                    (this.source = ''),
                    (i.client = t.client || !1),
                    (i.escapeFunction = t.escape || t.escapeFunction || s.escapeXML),
                    (i.compileDebug = !1 !== t.compileDebug),
                    (i.debug = !!t.debug),
                    (i.filename = t.filename),
                    (i.openDelimiter = t.openDelimiter || n.openDelimiter || '<'),
                    (i.closeDelimiter = t.closeDelimiter || n.closeDelimiter || '>'),
                    ...
                    (i.legacyInclude = void 0 === t.legacyInclude || !!t.legacyInclude),
                    i.strict ? (i._with = !1) : (i._with = void 0 === t._with || t._with),
                    (this.opts = i),
                ...
                (n.cache = s.cache),
                  ...
                  (n.render = function (e, t, n) {
                    var i = t || {},
                      r = n || {};
                    return 2 == arguments.length && s.shallowCopyFromList(r, i, l), m(r, e)(i);
                  }),
                        ...
                        ? ((t = i.shift()),
                          i.length
                            ...
                            : (t.settings &&
                                ...
                                (n = t.settings['view options']) && s.shallowCopy(a, n)),
                  ...
                  (x.prototype = {
                    ...
                    compile: function () {
                      ...
                      if (!this.source) {
                        if (
                          ...
                          for (
                            var d = '  var __locals = (' + i.localsName + ' || {}),\n', u = 0;
                      ...
                      (e = i.compileDebug
                        ...
                        i.client &&
                          ...
                          i.compileDebug && (e = 'rethrow = rethrow || ' + g.toString() + ';\n' + e)),
                        i.strict && (e = '"use strict";\n' + e),
                        i.debug && console.log(e),
                        i.compileDebug && i.filename && (e = e + '\n//# sourceURL=' + l + '\n');
                      try {
                        if (i.async)
                          try {
                        ...
                        : function (e) {
                            return t.apply(i.context, [
                              ...
                              function (t, n) {
                                ...
                                return n && (r = s.shallowCopy(r, n)), v(t, i)(r);
                              },
                              g,
                            ]);
                          };
                    ...
                    parseTemplateText: function () {
                      for (var e, t = this.templateText, n = this.regex, i = n.exec(t), r = []; i; )
                        0 !== (e = i.index) && (r.push(t.substring(0, e)), (t = t.slice(e))),
                          r.push(i[0]),
                      ...
                      switch (((t = e.split('\n').length - 1), e)) {
                        ...
                        case i + n + n:
                          (this.mode = x.modes.LITERAL),
                            (this.source += '    ; __append("' + e.replace(i + n + n, i + n) + '")\n');
                          break;
                        case n + n + r:
                          (this.mode = x.modes.LITERAL),
                            (this.source += '    ; __append("' + e.replace(n + n + r, n + r) + '")\n');
                          break;
                        case n + r:
                        case '-' + n + r:
                        case '_' + n + r:
                ...
                (function (e) {
                  ...
                  (n.resolve = function () {
                    ...
                    (n.relative = function (e, t) {
                      ...
                      for (
                        var r = i(e.split('/')), s = i(t.split('/')), a = Math.min(r.length, s.length), o = a, c = 0;
                        c < a;
                        c++
                      )
                        if (r[c] !== s[c]) {
                    ...
                    (n.dirname = function (e) {
                      ...
                      for (var t = e.charCodeAt(0), n = 47 === t, i = -1, r = !0, s = e.length - 1; s >= 1; --s)
                    ...
                    (n.extname = function (e) {
                      'string' != typeof e && (e += '');
                      for (var t = -1, n = 0, i = -1, r = !0, s = 0, a = e.length - 1; a >= 0; --a) {
                        var o = e.charCodeAt(a);
                        if (47 !== o)
                          -1 === i && ((r = !1), (i = a + 1)),
                            46 === o ? (-1 === t ? (t = a) : 1 !== s && (s = 1)) : -1 !== t && (s = -1);
                        else if (!r) {
                          n = a + 1;
                          break;
                        }
                      }
                      return -1 === t || -1 === i || 0 === s || (1 === s && t === i - 1 && t === n + 1)
                        ? ''
                        : e.slice(t, i);
                    });
            ...
            5: [
              function (e, t, n) {
                ...
                var l,
                  ...
                  h = -1;
                function m() {
                  u && l && ((u = !1), l.length ? (d = l.concat(d)) : (h = -1), d.length && p());
                }
                function p() {
                  if (!u) {
                    var e = c(m);
  ...
  (() => {
    ...
    var e = n(481),
      ...
      r = n(748);
    function s(e, n = {}) {
      n.title || (n.title = new Date().toISOString().slice(0, 16).replace('T', ' ')),
